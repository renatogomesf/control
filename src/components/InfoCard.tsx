export default function InfoCard({ title, text, info, className }: any) {
  return (
    <>
      <div
        className={`max-sm:min-w-[280px] basis-55 grow flex flex-col justify-between bg-PRIMARY text-TERTIARY px-5 py-3 rounded-xl border border-QUATERNARY ${className}`}
      >
        <div>
